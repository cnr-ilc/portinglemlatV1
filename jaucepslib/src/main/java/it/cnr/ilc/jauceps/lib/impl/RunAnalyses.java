...
//        //SilType lsil = getSil();
//
//        TabSaiQuery tabSaiq = new TabSaiQuery(conn);
//        /*LESSARIO*/
//        TabLessarioQuery tablessarioq = new TabLessarioQuery(conn);
//        List<TabLessario> tabsLessario = new ArrayList<>();
//        TabLessario areavs;
//        /*LESSARIO*/
//        if (flowDebug || deepFlowDebug) {
...
//        }
//        if (deepFlowDebug) {
//            logmess = String.format("DEEPFLOW COPYING in %s in Sillib.java rad -%s- on sil.radical -%s-", routine, rad, getSil().getRadical());
//            log.debug(logmess);
//
//        }
//        getSil().setRadical(rad);
//        if (deepFlowDebug) {
//            logmess = String.format("DEEPFLOW COPIED in %s in Sillib.java rad -%s- on sil.radical -%s-", routine, rad, getSil().getRadical());
//            log.debug(logmess);
//        }
//        if (callerDebug || deepFlowDebug) {
//            logmess = String.format("CALLING getSAISet radical=-%s- CALLER %s", getSil().getRadical(), routine);
//            log.debug(logmess);
//        }
//        tabsSai = tabSaiq.getSAIset(getSil().getRadical());
//        for (Iterator<TabSAI> TabSAIit = tabsSai.iterator(); TabSAIit.hasNext();) { // LOOP SAI
//            tabSai = TabSAIit.next();
//            if (deepFlowDebug) {
//                logmess = String.format("DEEPFLOW LOOP SAI. Counter sai -%d-  isanySAI -%s-", sai, tabSaiq.isAny());
//                log.debug(logmess);
//            }
//            if (callerDebug || deepFlowDebug) {
//                logmess = String.format("CALLING sairic radical=-%s- CALLER %s", getSil().getRadical(), routine);
//                log.debug(logmess);
//            }
//            setSil(sairic(tabSai));
//            rad_alt = getSil().getRad_alt();
//            /* loop over lessario */
//            if (callerDebug) {
